...
urlpatterns = [
    ...
    url(r'^(?P<user_id>\w+)/groups/$', views.UserGroups.as_view(), name=views.UserGroups.view_name),
    ...
    url(r'^(?P<user_id>\w+)/settings/create-project-permission/$', views.UserCreateProjectPermission.as_view(), name=views.UserChangePassword.view_name),
]
